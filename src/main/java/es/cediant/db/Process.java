...
public class Process  implements java.io.Serializable {
    ...
    private static final long serialVersionUID = 3687932717645166622L;
    ...
    public Process(User user, String name, String type, int priority, String status, Date startTime, Date endTime) {
       this.user = user;
       this.name = name;
       this.type = type;
       this.priority = priority;
